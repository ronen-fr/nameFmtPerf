...
//namespace ceph {
  ...
  public:
    ...
    virtual void flush(std::byte* buf, size_t buf_len)
    {
      std::ostream os(nullptr);
      os.rdbuf()->pubsetbuf(reinterpret_cast<char*>(buf), buf_len);
      flush(os);
    }
    ...
    virtual int test_extract(int n) = 0;
  };
